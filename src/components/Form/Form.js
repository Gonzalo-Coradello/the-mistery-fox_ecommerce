...
const Form = ({ handleCheckout }) => {
    ...
    return (
        <>
            <form className='form-control grid justify-center gap-16 mt-8 px-4'>
                ...
                {validateForm(validation) ?
                    <button onClick={handleSubmit} className='normal-case btn btn-outline w-fit mx-auto'>Generar orden</button> :
                    <button className='normal-case btn w-fit mx-auto btn-disabled' disabled>Generar orden</button>}
            </form>
        </>
    ) 
}
