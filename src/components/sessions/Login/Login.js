  ...
  return (
    <section>
      ...
      <form action="/sessions/login" method="post">
        ...
        <br></br>
        <button type="submit" onClick={handleSubmit} className="btn btn-outline mt-4">
          Enviar
        </button>
      </form>
      ...
      <p>
        <a
          href="/sessions/password_reset"
          className="btn btn-sm btn-ghost my-2 normal-case"
        >
      ...
      <p>
        <a
          ...
          className="btn btn-sm btn-ghost mt-1 normal-case"
        >
          Registrate
        </a>
      </p>

        <button className="btn md:btn-ghost mt-4 normal-case">
          Ingresar con Github
          <svg
            aria-hidden="true"
